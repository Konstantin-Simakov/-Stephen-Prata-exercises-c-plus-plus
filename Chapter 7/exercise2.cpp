// exercise2.cpp -- Chapter 7
#include <iostream>

int data_input(double [], int);
void display_results(const double [], int);
...
int main(void)
{
	...
	// the fact number of golf plays is a variable "plays" below
	...
	cout << "The average value of " << fact_plays << " fact golf plays "
		 << "is " << average << endl;
